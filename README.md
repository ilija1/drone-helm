...
(Based on the [stable Drone helm chart](https://github.com/helm/charts/tree/master/stable/drone) and @HighWayofLife 's [chart](https://github.com/HighwayofLife/helm-charts-drone))
